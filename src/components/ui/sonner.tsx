...
import { CheckmarkCircle01Icon, AlertCircleIcon, Loading03Icon, MultiplicationSignCircleIcon, Alert02Icon } from "@hugeicons/core-free-icons";
  ...
  return (
    <Sonner
      ...
      icons={{
        ...
        info: <HugeiconsIcon icon={AlertCircleIcon} strokeWidth={2} className="size-4" />,
