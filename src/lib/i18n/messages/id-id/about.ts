export const aboutMessages = {
  ...
  documentDescription:
    "Pelajari lebih lanjut tentang Fleetime Labs - alat andal untuk simulasi skenario penagihan (biller)",
  ...
  endpointManagementDescription:
    "Konfigurasi dan pantau endpoint API penagihan dengan pelacakan status waktu nyata (real-time)",
