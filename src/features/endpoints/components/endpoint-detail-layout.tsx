...
export function EndpointDetailLayout({
  ...
  return (
    <>
      {/* Mobile: Tabs layout */}
      <Card className="overflow-hidden rounded-2xl border-2 border-border/80 border-b-4 bg-card/90 shadow-sm lg:hidden">
      ...
      <Card className="hidden overflow-hidden rounded-2xl border-2 border-border/80 border-b-4 bg-card/90 shadow-sm lg:block">
